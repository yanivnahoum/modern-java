...
import static com.att.tlv.training.java8.exercises.streams.GroupingCollectors.*;
...
public class GroupingCollectorsTest {
    ...
    public void testGroupById() {
        ...
        assertThat(idToPersons).containsOnly(entry(alice.getId(), listOf(alice)), entry(bob.getId(), listOf(bob)), entry(jim.getId(), listOf(jim, carl)));
    }
    ...
    public void testGroupByNameToIds() {
        ...
        assertThat(nameToIds).containsOnly(entry(alice.getName(), listOf(alice.getId())), entry(bob.getName(), listOf(bob.getId())), entry(jim.getName(), listOf(jim.getId(), carl.getId())));        
    }
